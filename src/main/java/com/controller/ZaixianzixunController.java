...
public class ZaixianzixunController {
    ...
    public R page(@RequestParam Map<String, Object> params,ZaixianzixunEntity zaixianzixun, 
		...
		if(tableName.equals("yisheng")) {
			zaixianzixun.setYishenggonghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("huanzhe")) {
			zaixianzixun.setHuanzhezhanghao((String)request.getSession().getAttribute("username"));
		}
